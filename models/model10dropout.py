...
class DenoisingFeatureDataset(Dataset):
    def __init__(self, X, mask_prob=0.15, noise_std=0.1):
...
# --- 2. MLP Autoencoder with Dropout ---
...
# --- 3. Train Autoencoder ---
def train_autoencoder(X, mask_prob=0.15, epochs=200, batch_size=64):
...
if __name__ == "__main__":
    ...
    model = train_autoencoder(X_train, mask_prob=0.33, epochs=200)
