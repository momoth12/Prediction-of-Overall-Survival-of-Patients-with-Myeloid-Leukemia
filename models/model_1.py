# model1.py: Random Survival Forest with clinical + molecular features
...
X_clinical = np.hstack([X_num, X_cat])
...
X_clinical_test = np.hstack([X_num_test, X_cat_test])
...
# --- Retrain RSF on full data and predict ---
...
submission_dir = "../submissions/submission_model_1.csv"
